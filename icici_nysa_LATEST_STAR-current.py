...
def read_details(start_row=4):
    ...
    positional_map = {
        ...
        3:"vehicle_reg_number", 4:"mobile_number",    5:"email",
        6:"policy_type",        7:"current_reg_type",  8:"rto",
        9:"manufacturer_model", 10:"manufacturing_year",11:"tenure",
        12:"idv",               13:"pan_number",       14:"aadhaar_number",
        15:"engine_number",     16:"chassis_number",   17:"insured_name",
        18:"dob",               19:"address_line",     20:"mobile_number",
        21:"email",             22:"pin_code",         23:"gst_number",
        24:"gst_state",         25:"addons",           26:"auto_pay",
        25:"loan_hypothecation", 26:"financier_name",   27:"financier_branch",
        28:"addons",             29:"auto_pay",
        30:"pid_number",         31:"proposal_number",
    }

    import re as _re
    headers = {}
    header_row_found = False
    for col in range(1, 34):  # cols 1-33: includes KYC Pincode (33), PID Number (30), Proposal Number (31), Policy Number (32)
...
def save_proposal_number(D, proposal_no):
    ...
    try:
        ...
        ws = wb["Details"]
        ws.cell(row=excel_row, column=31, value=proposal_no)
        wb.save(EXCEL_PATH)
        print(f"  Proposal number '{proposal_no}' saved to Details row {excel_row}, col 31")
...
def save_policy_number(D, policy_no):
    ...
    try:
        ...
        wb = openpyxl.load_workbook(EXCEL_PATH)
        ws = wb["Details"]
        ws.cell(row=excel_row, column=32, value=policy_no)
        wb.save(EXCEL_PATH)
        print(f"  Policy number '{policy_no}' saved to Details row {excel_row}, col 32")
    except Exception as e:
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            if not skip_to_step4:
                ...
                # ── STEP 3: Type NEW in Registration Number & Fetch ────
                # From video: after clicking New, portal shows Registration Number
                # field. For new car, type "NEW" then click "Fetch Vehicle Details"
                # which reveals the RTO, Manufacturer-Model, IDV, Reg Type fields.
                log("step", "STEP 3 — Enter NEW + Fetch Vehicle Details")
